...
//     res.json(data);
//   } catch (err) {
//     console.error("TOP STATIONS ERROR:", err);
...
//     const match = {
//       "Year Text": { $gte: startYear, $lte: endYear }
//     };

//     if (cargoType && cargoType !== "ALL") {
//       match.TYPE = cargoType;
//     }
...
//         year: y,
//         values: MONTHS.map(m => {
//           const r = monthlyRaw.find(x => x._id.year === y && x._id.month === m);
//           return r ? r.total : 0;
//         })
//       }))
//     };
...
//       values: data.map(d => Math.round(d.total))
//     });
//   } catch (err) {
//     console.error("CARGO MIX ERROR:", err);
...
//     });
//   } catch (err) {
//     console.error("MARKET STATION ERROR:", err);
...
//     });
//   } catch (err) {
//     console.error("MARKET CARGO ERROR:", err);
